...
### Bandwidth
Start [Iperf3](https://github.com/esnet/iperf) to test TCP bandwidth and starts [Siffle](https://github.com/djxy/siffle) to test latency with a TCP connection.
...
### Bandwidth
Start [Iperf3](https://github.com/esnet/iperf) to test UDP bandwidth and starts [Siffle](https://github.com/djxy/siffle) to test latency with a UDP connection.
...
```bash
docker run --rm -it -v ./tests:/tests --network siffleux-benchmark_default siffleux-benchmark http stress --tunnel siffleux
```
